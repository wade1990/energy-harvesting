% !TEX root = main.tex
The Transmitter energy arrival instants are marked by $t_i$'s with energy $\mathcal{E}_i$. % while the receiver energy arrivals are marked by $r_i$'s with energy $\mathcal{R}_i$ for $i \in \{0,1..\}$. 
